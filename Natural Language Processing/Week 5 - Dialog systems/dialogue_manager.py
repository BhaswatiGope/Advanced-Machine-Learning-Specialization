...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        best_thread = pairwise_distances_argmin(question_vec.reshape(1, self.embeddings_dim), thread_embeddings)#### YOUR CODE HERE ####
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.chitchat_bot = ChatBot("Bhaswati's ChatBot")
